...
function CustomTooltip({ active, payload, formatter }: any) {
   ...
   const { income, expense, vatBalance } = data;

   return (
      <div className="min-w-[300px] rounded border bg-background p-4 space-y-2">
         <TooltipRow
            formatter={formatter}
            label="Prihodi"
            value={income}
